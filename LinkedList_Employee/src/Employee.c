...
/** \brief Validacion de horas trabajadas//VALIDA ENTEROS MODIFICAR NOMBRE Y VALIDACION DE SER NECESARIO
 *
...
/**************************************************/
/* SET CON PARAMETROS
 * TODO SE LEE COMO TEXTO
 * CREAR BUFFER PARA LOS DATOS QUE NO SON CHAR, ASI SE CAMBIA EL TIPO DE DATO AL NECESARIO ANTES DE PASAR EL DATO A LOS SET
 *
 */
...
//CAMBIAR LOS ARGUMENTOS EN FUNCION DEL CAMPO DE LA ESTRUCTURA NUEVA
